//
//  StatTabeHeaderChangeAlignment.swift
//  Path2e
//
...
struct StatTabHeaderChangeAlignment: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ethics = realmManager.character.ethicsAlignment
            morals = realmManager.character.moralsAlignment
        }
    }
}
